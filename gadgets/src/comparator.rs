...
impl<F: FieldExt, const N_BYTES: usize> ComparatorConfig<F, N_BYTES> {
...
impl<F: FieldExt, const N_BYTES: usize> ComparatorChip<F, N_BYTES> {
...
impl<F: FieldExt, const N_BYTES: usize> Chip<F> for ComparatorChip<F, N_BYTES> {
