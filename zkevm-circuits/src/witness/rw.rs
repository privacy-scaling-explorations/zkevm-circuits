...
// Allow missing docs for sub properties.
// Some of the docs are tedious and can be found at
// https://github.com/privacy-scaling-explorations/zkevm-specs/blob/master/specs/tables.md
#[allow(missing_docs)]
