    ...
    pub(crate) fn new(
        ...
        let state = {
            StepState {
                ...
                call_id: cell_manager.query_cell(CellType::General),
                is_root: cell_manager.query_cell(CellType::General),
                is_create: cell_manager.query_cell(CellType::General),
                opcode_source: cell_manager.query_cell(CellType::General),
