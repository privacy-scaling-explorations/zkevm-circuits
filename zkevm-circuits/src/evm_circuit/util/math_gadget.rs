...
impl<F: Field> MulAddWordsGadget<F> {
    pub(crate) fn construct(cb: &mut ConstraintBuilder<F>, a: util::Word<F>, b: util::Word<F>, c: util::Word<F>, d: util::Word<F>) -> Self {
...
impl<F: Field> MulAddWords512Gadget<F> {
    ...
    pub(crate) fn construct(cb: &mut ConstraintBuilder<F>, a: util::Word<F>, b: util::Word<F>, c: util::Word<F>, d: util::Word<F>, e: util::Word<F>) -> Self {
    ...
    pub(crate) fn assign(
        ...
        region: &mut CachedRegion<'_, '_, F>,
        offset: usize,
        a: Word, b: Word, c:Word, d: Word, e: Word,
    ) -> Result<(), Error> {
        self.a.assign(region, offset, Some(a.to_le_bytes()))?;
        self.b.assign(region, offset, Some(b.to_le_bytes()))?;
        self.c.assign(region, offset, Some(c.to_le_bytes()))?;
