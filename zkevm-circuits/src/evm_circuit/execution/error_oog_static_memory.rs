...
impl<F: Field> ExecutionGadget<F> for ErrorOOGStaticMemoryGadget<F> {
    ...
    fn configure(cb: &mut ConstraintBuilder<F>) -> Self {
        ...
        // let is_mstore8 = IsEqualGadget::construct(cb, opcode.expr(),
        // OpcodeId::MSTORE8.expr()); let is_not_mstore8 = 1.expr() -
        // is_mstore8.expr();
        ...
        // let address_in_range = IsZeroGadget::construct(cb,
        // address_high::expr(&address)); // Check if the amount of gas
        // available is less than the amount of gas // required
