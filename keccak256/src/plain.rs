...
fn test_mpt() {
    let input = [
        248, 81, 128, 160, 144, 251, 124, 202, 220, 92, 31, 133, 222, 150, 215,
        207, 225, 250, 167, 226, 181, 121, 66, 196, 246, 55, 16, 157, 64, 177,
        79, 73, 60, 151, 194, 209, 128, 128, 128, 128, 128, 128, 128, 128, 160,
        141, 203, 27, 132, 71, 133, 121, 242, 117, 169, 74, 104, 137, 216, 230,
        118, 125, 138, 242, 115, 166, 118, 39, 237, 209, 234, 156, 251, 107,
        97, 244, 220, 128, 128, 128, 128, 128, 128,
    ];
    let output = [
        169, 184, 158, 55, 8, 215, 67, 17, 7, 135, 162, 219, 160, 221, 5, 17,
        129, 106, 64, 40, 193, 232, 134, 216, 205, 151, 23, 215, 168, 161, 234,
        80,
    ];
    println!("{:?}", keccak256(&input));
    // assert_eq!(keccak256(&input), output);
}
