...
/// Represents a single step of an [`ExecutionTrace`]. It contains all of the
/// information relative to this step:
...
/// - Bus Mapping instances containing references to all of the [`Operation`]s
...
impl ExecutionStep {
    ...
    ///
    /// ## Returns the #operations added by the [`OpcodeId`] into the container.
