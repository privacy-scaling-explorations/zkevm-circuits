...
use crate::circuit_input_builder::{
    CallContextFieldTag, CircuitInputStateRef, ExecState, ExecStep, TxLogFieldTag,
};
...
fn gen_copy_steps(
    ...
    for (idx, byte) in mem.iter().enumerate() {
        ...
        // Read memory
        state.memory_read(exec_step, call_id, (addr as usize).into(), *byte)?;
...
//         // prepare memory data
//         let pushdata =
// hex::decode("1234567890abcdef1234567890abcdef").unwrap();         let mut
// memory_data = std::iter::repeat(0)             .take(16)
...
//                 (
//                     RW::READ,
//                     &StackOp::new(1, StackAddress::from((1022 - topic_count)
// as u32), Word::from(mstart))                 ),
//                 (
//                     RW::READ,
//                     &StackOp::new(1, StackAddress::from((1023 - topic_count)
// as u32), Word::from(msize))                 )
//             ]
//         );
...
//                     &CallContextOp {
//                         call_id: 1,
//                         field: CallContextFieldTag::IsStatic,
//                         value: Word::from(0),
//                     },
//                 ),
//                 (
...
//                     &CallContextOp {
//                         call_id: 1,
//                         field: CallContextFieldTag::CalleeAddress,
...
//             log_topic_ops.push((
//                 RW::WRITE,
//                 TxLogOp::new(1, step.log_id + 1, TxLogFieldTag::Topic, idx,
// *topic),             ));
//         }
//         assert_eq!(
//             (1..1 + topic_count)
...
//                     memory_ops.push((
//                         RW::READ,
//                         MemoryOp::new(1, (mstart + idx).into(),
...
//                         TxLogOp::new(
//                             1,
//                             step.log_id + 1, // because it is in next
// CopyToLog step                             TxLogFieldTag::Data,
//                             idx - mstart,
