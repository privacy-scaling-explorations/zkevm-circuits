...
use crate::{circuit_input_builder::CallContext, error::ExecError};
use eth_types::{
...
pub struct ExecStep {
    ...
    pub bus_mapping_instance: Vec<usize>,
...
impl CopyEvent {
    ...
    pub fn rw_counter(&self, step_index: usize) -> u64 {
        u64::try_from(self.rw_counter_start).unwrap() + self.rw_counter_increase(step_index)
    }
