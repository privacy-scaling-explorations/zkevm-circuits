...
use eth_types::{
    ...
    Address, GethExecStep, Word, H256,
};
...
impl ExecStep {
    ...
    pub fn new(
        ...
        ExecStep {
            ...
            error: None,
            non_existent_accounts: HashSet::new(),
        }
    }
    ...
    /// Add a non existent account address.
    pub fn add_non_existent_account(&mut self, address: Address) {
        self.non_existent_accounts.insert(address);
    }
}
