    ...
    pub fn configure(
        ...
        meta.create_gate("Branch rows", |meta| {
            ...
            */
            ...
            // this way we just rotate back to one of the branch children rows and we get mod_node_hash_rlc there
            ...
            let mod_node_hash_rlc_prev =
                meta.query_advice(mod_node_hash_rlc, Rotation::prev());
            let mod_node_hash_cur =
                meta.query_advice(mod_node_hash_rlc, Rotation::cur());
            constraints.push((
            ...
            // s_mod_node_hash_rlc and c_mode_node_hash_rlc correspond to RLC of s_advices and c_advices
